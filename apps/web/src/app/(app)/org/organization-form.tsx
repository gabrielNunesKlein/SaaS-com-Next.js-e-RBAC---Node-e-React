...
import { createOrganizationAction, OrganizationSchema, updateOrganizationAction } from './[slug]/actions'
...
export default function OrganizationForm({ isUpdating = false, initialData }: OrganizationFormProps) {

    const formAction = isUpdating ? updateOrganizationAction : createOrganizationAction

    const [{success, errors, message}, handleSubmit, isPading] = useFormState(formAction)
